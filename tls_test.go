...
func TestDecodeTLSConfiguration(t *testing.T) {
	...
	invalid := map[string]string{
		...
		"site placement":    `{"listen":":8080","sites":[{"hosts":["*"],"target":"http://localhost:3000","tls":{"cert":"a","key":"b"}}]}`,
		"route placement":   `{"listen":":8080","sites":[{"hosts":["*"],"target":"http://localhost:3000","routes":[{"path":"/*","tls":{"cert":"a","key":"b"}}]}]}`,
		"backend placement": `{"listen":":8080","backends":{"app":{"targets":["http://localhost:3000"],"tls":{"cert":"a","key":"b"}}},"sites":[{"hosts":["*"],"backend":"app"}]}`,
